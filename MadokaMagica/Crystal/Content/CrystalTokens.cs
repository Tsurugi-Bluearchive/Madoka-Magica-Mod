...
{
    public static class CrystalTokens
    {
        ...
        {
            var prefix = CrystalSurvivor.CRYSTAL_PREFIX;
            ...
            Language.Add(prefix + "NAME", "Megumin Tomoe");
            ...
            Language.Add(prefix + "PRIMARY_SCARF_DESCRIPTION", $"Swing forward for <style=cIsDamage>{100f * CrystalStaticValues.swordDamageCoefficient}% damage</style>.");
            #endregion

            #region Secondary
            Language.Add(prefix + "SECONDARY_GUN_NAME", "Precision Strike");
            Language.Add(prefix + "SECONDARY_GUN_DESCRIPTION", $"IMPLANT. Hold still and fire a picked up gun for <style=cIsDamage>{100f * CrystalStaticValues.gunDamageCoefficient}% damage</style>.");
            #endregion
            ...
            Language.Add(prefix + "SPECIAL_BOMB_DESCRIPTION", $"Throw a bomb for <style=cIsDamage>{100f * CrystalStaticValues.bigGunDamageCefficeient}% damage</style>.");
            #endregion

            #region Achievements
            Language.Add(Tokens.GetAchievementNameToken(CrystalMasteryAchievements.identifier), "Henry: Mastery");
            Language.Add(Tokens.GetAchievementDescriptionToken(CrystalMasteryAchievements.identifier), "As Henry, beat the game or obliterate on Monsoon.");
            #endregion
        }
    }
}
