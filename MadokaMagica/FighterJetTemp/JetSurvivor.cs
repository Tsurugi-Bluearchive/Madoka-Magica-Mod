...
namespace MadokaMagica.Jet
{
    public class JetSurvivor : SurvivorBase<JetSurvivor>
    {
        //used to load the assetbundle for this character. must be unique
        public override string assetBundleName => "jetassetbundle"; //if you do not change this, you are giving permission to deprecate the mod

        //the name of the prefab we will create. conventionally ending in "Body". must be unique
        public override string bodyName => "JetBody"; //if you do not change this, you get the point by now

        //name of the ai master for vengeance and goobo. must be unique
        public override string masterName => "JetMonsterMaster"; //if you do not

        //the names of the prefabs you set up in unity that we will use to build your character
        public override string modelPrefabName => "mdlJet";
        public override string displayPrefabName => "JetDisplay";

        public const string JET_PREFIX = MagicaPlugin.DEVELOPER_PREFIX + "_Jet_";

        //used when registering your survivor's language tokens
        public override string survivorTokenPrefix => JET_PREFIX;
        
        public override BodyInfo bodyInfo => new BodyInfo
        {
            bodyName = bodyName,
            bodyNameToken =  JET_PREFIX + "NAME",
            subtitleNameToken = JET_PREFIX + "SUBTITLE",
        ...
        private void AddPassiveSkill()
        {
            ...
            {
                enabled = true,
                skillNameToken = JET_PREFIX + "PASSIVE_NAME",
                skillDescriptionToken = JET_PREFIX + "PASSIVE_DESCRIPTION",
        ...
        private void AddPrimarySkills()
        {
            ...
            precisionStrike = Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                skillNameToken = JET_PREFIX + "PRIMARY_GUN_NAME",
                skillDescriptionToken = JET_PREFIX + "PRIMARY_GUN_DESCRIPTION",
        ...
        private void AddSecondarySkills()
        {
            ...
            ceaselessBarage = Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                skillNameToken = JET_PREFIX + "SECONDARY_BARAGE_NAME",
                skillDescriptionToken = JET_PREFIX + "SECONDARY_BARRAGE_DESCRIPTION",
                keywordTokens = ["KEWORD_IMPLANT"],
            ...
            reload = Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.AirsStrike)),
                activationStateMachineName = "Weapon",
                interruptPriority = EntityStates.InterruptPriority.Skill,
        ...
        private void AddUtiitySkills()
        {
            ...
            {
                skillName = "HenryRoll",
                skillNameToken = JET_PREFIX + "UTILITY_ROLL_NAME",
                skillDescriptionToken = JET_PREFIX + "UTILITY_ROLL_DESCRIPTION",
        ...
        private void AddSpecialSkills()
        {
            ...
            {
                skillName = "MamiBlast",
                skillNameToken = JET_PREFIX + "SPECIAL_BLAST_NAME",
                skillDescriptionToken = JET_PREFIX + "SPECIAL_BLAST_DESCRIPTION",
        ...
        public override void InitializeSkins()
        {
            ...
            //SkinDef masterySkin = Modules.Skins.CreateSkinDef(JET_PREFIX + "MASTERY_SKIN_NAME",
