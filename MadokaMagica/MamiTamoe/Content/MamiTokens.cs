...
namespace MadokaMagica.MamiTamoe.Content
{
    public static class MamiTokens
    {
        ...
        {
            var prefix = MamiSurvivor.MAMI_PREFIX;
            ...
            #region Achievements
            Language.Add(Tokens.GetAchievementNameToken(MamiMasteryAchievements.identifier), "Henry: Mastery");
            Language.Add(Tokens.GetAchievementDescriptionToken(MamiMasteryAchievements.identifier), "As Henry, beat the game or obliterate on Monsoon.");
            #endregion
        }
    }
}
