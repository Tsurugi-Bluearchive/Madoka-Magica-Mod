...
namespace MadokaMagica.Megumin
{
    public class MeguminSurvivor : SurvivorBase<MeguminSurvivor>
    {
        ...
        public override string bodyName => "MeguminBody"; //if you do not change this, you get the point by now

        //name of the ai master for vengeance and goobo. must be unique
        public override string masterName => "MeguminMonsterMaster"; //if you do not

        //the names of the prefabs you set up in unity that we will use to build your character
        public override string modelPrefabName => "mdlMegumin";
        public override string displayPrefabName => "MeguminDisplay";

        public const string MEGUMIN_PREFIX = MagicaPlugin.DEVELOPER_PREFIX + "_MEGUMIN_";

        //used when registering your survivor's language tokens
        public override string survivorTokenPrefix => MEGUMIN_PREFIX;
        
        public override BodyInfo bodyInfo => new BodyInfo
        {
            bodyName = bodyName,
            bodyNameToken = MEGUMIN_PREFIX + "NAME",
            subtitleNameToken = MEGUMIN_PREFIX + "SUBTITLE",
        ...
        public override UnlockableDef characterUnlockableDef => MeguminUnlockables.characterUnlockableDef;
        
        public override ItemDisplaysBase itemDisplays => new MegumintemDisplays();
        ...
        private void AddPassiveSkill()
        {
            ...
            {
                enabled = true,
                skillNameToken = MEGUMIN_PREFIX + "PASSIVE_NAME",
                skillDescriptionToken = MEGUMIN_PREFIX + "PASSIVE_DESCRIPTION",
        ...
        private void AddPrimarySkills()
        {
            ...
            explosionCast = Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                skillNameToken = MEGUMIN_PREFIX + "PRIMARY_GUN_NAME",
                skillDescriptionToken = MEGUMIN_PREFIX + "PRIMARY_GUN_DESCRIPTION",
        ...
        private void AddSecondarySkills()
        {
            ...
            ceaselessBarage = Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                skillNameToken = MEGUMIN_PREFIX + "SECONDARY_BARAGE_NAME",
                skillDescriptionToken = MEGUMIN_PREFIX + "SECONDARY_BARRAGE_DESCRIPTION",
                keywordTokens = ["KEWORD_IMPLANT"],
        ...
        private void AddUtiitySkills()
        {
            ...
            {
                skillName = "HenryRoll",
                skillNameToken = MEGUMIN_PREFIX + "UTILITY_ROLL_NAME",
        ...
        public override void InitializeSkins()
        {
            ...
            //SkinDef masterySkin = Modules.Skins.CreateSkinDef(MEGUMIN_PREFIX + "MASTERY_SKIN_NAME",
