...
{
    public class Reload : BaseZiluSkillState
    {
        ...
        public override void OnExit()
        {
            ...
            skillLocator.secondary.UnsetSkillOverride(this.gameObject, ZiluSurvivor.reload, GenericSkill.SkillOverridePriority.Default);
