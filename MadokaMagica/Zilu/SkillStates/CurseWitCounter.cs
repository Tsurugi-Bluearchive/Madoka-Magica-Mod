...
{
    public class CurseWitCounter : BaseJetSkillState
    {
        ...
        public override void OnExit()
        {
            ...
            {
                skillLocator.secondary.SetSkillOverride(this.gameObject, JetSurvivor.reload, GenericSkill.SkillOverridePriority.Default);
