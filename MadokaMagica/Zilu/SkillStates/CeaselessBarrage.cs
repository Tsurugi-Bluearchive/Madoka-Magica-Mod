...
{
    public class CeaselessBarrage : BaseZiluSkillState
    {
        public static float damageCoefficient = ZiluStaticValues.barrageDamageCefficient;
        ...
        public override void OnExit()
        {
            ...
            {
                skillLocator.secondary.SetSkillOverride(this.gameObject, ZiluSurvivor.reload, GenericSkill.SkillOverridePriority.Default);
